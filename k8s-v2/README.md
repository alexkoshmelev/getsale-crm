# GetSale v2 — Kubernetes Deployment
...
kubectl apply -f k8s-v2/secrets.yaml
kubectl apply -f k8s-v2/configmap.yaml
kubectl apply -f k8s-v2/postgres.yaml
kubectl apply -f k8s-v2/redis.yaml
kubectl apply -f k8s-v2/rabbitmq.yaml
```
...
```bash
kubectl apply -f k8s-v2/migrations-job.yaml
