...
- [CAMPAIGNS.md](CAMPAIGNS.md) — цели, статус реализации кампаний и бэклог.
- **STATE_AND_ROADMAP.md** — общая дорожная карта.

После реализации пунктов из разделов 3 и 4 обновлять этот файл и статус в [CAMPAIGNS.md](CAMPAIGNS.md).
