...
Краткая сводка целей и статуса. Детальные планы по этапам были объединены в этот документ; ключевые архитектурные решения отражены в [ARCHITECTURE.md](ARCHITECTURE.md) и [STATE_AND_ROADMAP.md](STATE_AND_ROADMAP.md).
...
**Статус:** В плане (см. STATE_AND_ROADMAP, приоритет «Надёжность»). После ЭТАПА 5 — ЭТАП 6 (DLQ).
...
Текущий порядок: 1 → 3 → стабилизация → 2 → 4. Далее: **ЭТАП 5 (Observability)** — затем DLQ и при необходимости ЭТАП 6 (SLA). Приоритеты и чеклист к продакшену — в [STATE_AND_ROADMAP.md](STATE_AND_ROADMAP.md).
