...
- Папка «Новые лиды» (first_manager_reply_at IS NULL), бейджи Lead/Contact в списке чатов, правая панель Lead Panel (pipeline, stage, timeline). Детали — в [STAGES.md](STAGES.md) (ЭТАП 7).

Приоритеты и бэклог — [STATE_AND_ROADMAP.md](STATE_AND_ROADMAP.md).
